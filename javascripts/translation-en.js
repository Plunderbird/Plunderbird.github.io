...
exportObj.cardLoaders.English = function() {
  ...
  upgrade_translations = {
    ...
    "Supercharger": {
      text: "<strong>Setup:</strong> Lose 3 %CHARGE%. %LINEBREAK% After you fully execute a speed 3-5 maneuver, recover 1 %CHARGE%. Then, you <strong>must</strong> spend 3 %CHARGE%, if able, to perform a %SLAM% action, even while stressed. Then, remove 1 disarm token."
    },
    "Diamond-lined Windshield": {
      text: "Whenever you would suffer the effects of moving through or overlapping an obstacle, roll 1 defense die. On an %EVADE% result, do not suffer the effects of that obstacle."
    },
    "Suspicious-looking Droid": {
      text: "<strong>Suspicious-looking Droid: </strong>Setup: Equip this side faceup. %LINEBREAK% During the System Phase, if you have any active %CHARGE%, you <strong>must</strong> spend 1 %CHARGE% to gain 1 %CALCULATE% token. %LINEBREAK% During the End Phase, if this card has 0 active %CHARGE%, flip it. %LINEBREAK% <strong>Revolutionary Droid:</strong> Whenever you would gain a focus token, you gain a calculate token instead. Treat all of your effects that refer to focus tokens as referring to calculate tokens instead."
    },
    "Scavenged Upgrade": {
      text: "<strong>Setup:</strong> Before you deploy, select one of the following upgrades at random and equip it to your ship (ignoring all requirements and without paying its cost): %LINEBREAK% Deadman's Switch, BT-1, Ion Limiter Override, Pattern Analyzer, Heavy Laser Cannon, Collision Detector, Hondo Ohnaka, GNK 'Gonk' Droid"
    },
    ...
    "Overclocked Hyperdrive": {
      text: "<strong>Setup:</strong> When you would be deployed, randomly select an objective marker. Deploy from that marker instead, inserting the [1 %STRAIGHT%] template into either set of guides and aligning it with your rear guides."
    },
    "Defective Jawaballs": {
      text: "During the System Phase, you may spend 1 %CHARGE% to launch a Defective Jawaball using the [1 %STRAIGHT%] template. This card's %CHARGE% cannot be recovered."
    },
    "Fanatic (BoY)": {
